...
# # ---- Multilingual Emotion Detection using Hugging Face Inference API -- Optimization Needed on streamlit or any other platfrom taking too much time to display data.
